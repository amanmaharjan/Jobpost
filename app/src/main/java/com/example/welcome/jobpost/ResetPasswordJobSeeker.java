...
public class ResetPasswordJobSeeker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_password_job_seeker);
        email=(EditText)findViewById(R.id.JresetEmail);
        password=(EditText)findViewById(R.id.JresetPassword);
        confirmPassword=(EditText)findViewById(R.id.JresetConfirmPassword);
        resetPassword=(Button)findViewById(R.id.JresetbtnPassword);
    ...
    private void resetPassword() {
        StringRequest strReq = new StringRequest(Request.Method.POST,AppConfig.URL_Jobseeker_RESET , new Response.Listener<String>() {
